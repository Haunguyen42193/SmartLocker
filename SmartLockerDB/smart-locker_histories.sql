...
CREATE TABLE `histories` (
  `histoy_id` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_id` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `locker_id` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2023-09-15 12:52:12
